...
//////////////////////////////////
if (
  MAIN.browser.name == "androind_firefox" ||
  MAIN.browser.name == "android_tab_firefox"
) {
  ...
  var double_click = 0;
  document.getElementById("HUBB").addEventListener(
    "touchstart",
    function(event) {
  ...
  var double_click1 = 0;
  document.getElementById("HUBL").addEventListener(
    "touchstart",
    function(event) {
      //event.preventDefault();
      var touch = event.touches[0];
  ...
  var double_click2 = 0;
  document.getElementById("HUBR").addEventListener(
    "touchstart",
    function(event) {
      // event.preventDefault();
      var touch = event.touches[0];
  ...
  var double_click3 = 0;
  document.getElementById("HUBF").addEventListener(
    "touchstart",
    function(event) {
      // event.preventDefault();
      var touch = event.touches[0];
  ...
  MAIN.browser.name == "desktop_firefox" ||
  MAIN.browser.name == "desktop_chrome"
) {
