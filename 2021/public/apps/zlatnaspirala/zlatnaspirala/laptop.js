...
function LAPTOP(TX, TY, TZ) {
  ...
  if (laptopVertexPositionBuffer) {
    ...
    gl.vertexAttribPointer(
      ...
      laptopVertexPositionBuffer.itemSize,
      gl.FLOAT,
      false,
      0,
      0
    ...
    gl.vertexAttribPointer(
      ...
      laptopVertexTextureCoordBuffer.itemSize,
      gl.FLOAT,
      false,
      0,
      0
    ...
    gl.vertexAttribPointer(
      ...
      laptopVertexNormalBuffer.itemSize,
      gl.FLOAT,
      false,
      0,
      0
    ...
    gl.drawElements(
      gl.TRIANGLES,
      laptopVertexIndexBuffer.numItems,
      gl.UNSIGNED_SHORT,
      0
    );
  }
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    laptopScreenVertexNormalBuffer.itemSize,
    gl.FLOAT,
    false,
    0,
    0
...
function handleLoadedLaptop(laptopData) {
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(laptopData.vertexNormals),
    gl.STATIC_DRAW
  );
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(laptopData.vertexTextureCoords),
    gl.STATIC_DRAW
  );
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(laptopData.vertexPositions),
    gl.STATIC_DRAW
  );
  ...
  gl.bufferData(
    ...
    new Uint16Array(laptopData.indices),
    gl.STREAM_DRAW
  );
