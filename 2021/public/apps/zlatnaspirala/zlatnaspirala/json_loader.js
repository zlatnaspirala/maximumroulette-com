function handleJsonData(DATA, ID) {
  ...
  window["VERTEX_POSITION_JSON_" + ID].numItems =
...
function OBJECT3D(ID, TX, TY, TZ, texture, Blend, RotBy, Angle, RotateSpeed) {
  ...
  if (window["VERTEX_POSITION_JSON_" + ID]) {
    ...
    gl.vertexAttribPointer(
      ...
      window["VERTEX_POSITION_JSON_" + ID].itemSize,
      gl.FLOAT,
      false,
      0,
      0
    ...
    gl.vertexAttribPointer(
      ...
      window["TEXTURE_COORD" + ID].itemSize,
      gl.FLOAT,
      false,
      0,
      0
    ...
    gl.vertexAttribPointer(
      ...
      window["VERTEX_NORMALS" + ID].itemSize,
      gl.FLOAT,
      false,
      0,
      0
    ...
    gl.drawElements(
      gl.TRIANGLES,
      window["VERTEX_INDEX" + ID].numItems,
      gl.UNSIGNED_SHORT,
      0
    );
  }
