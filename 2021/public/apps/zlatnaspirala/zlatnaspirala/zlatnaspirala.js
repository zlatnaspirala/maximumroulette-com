function BLOCK(TX, TY, TZ, tekstura) {
  ...
  gl.vertexAttribPointer(
    ...
    cubeVertexPositionBufferPOD1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    ...
    cubeVertexNormalBufferPOD1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    ...
    cubeVertexTextureCoordBufferPOD1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferPOD1.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
...
function PENJLEVI(TXL, TYL, TZL) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferPENJLEVI.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    cubeVertexNormalBufferPENJLEVI.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferPENJLEVI.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferPENJLEVI.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
  mvPopMatrix();
...
function XWALL(TXL, TYL, TZL, tekstura) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferZID1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    cubeVertexNormalBufferZID1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferZID1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferZID1.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
  mvPopMatrix();
...
function PILEY(TXL, TYL, TZL, tekstura) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferSTUBB.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    cubeVertexNormalBufferSTUBB.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferSTUBB.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferSTUBB.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
  mvPopMatrix();
...
function BLADEROTATE(TXL, TYL, TZL, tekstura, speedrot) {
  //auto rotate blade
  mvPushMatrix();
  mat4.translate(mvMatrix, [0.0, 0.0, 0.0]);
  NIK = NIK + speedrot;
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferSILJAK.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    cubeVertexNormalBufferSILJAK.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferSILJAK.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferSILJAK.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
  mvPopMatrix();
}
function DEADFLOOR(TXL, TYL, TZL, tekstura) {
  //auto rotate blade
  mvPushMatrix();
  mat4.translate(mvMatrix, [0.0, 0.0, 0.0]);
  // NIK=NIK+1;
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferSILJAK1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    cubeVertexNormalBufferSILJAK1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferSILJAK1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferSILJAK1.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
  mvPopMatrix();
...
function DEADBLADE(TXL, TYL, TZL, tekstura) {
  //auto rotate blade
  mvPushMatrix();
  mat4.translate(mvMatrix, [0.0, 0.0, 0.0]);
  if (nik001 == 0) {
...
function BLADEROTATEDEGX(TXL, TYL, TZL, tekstura, DEGG) {
  //auto rotate blade
  mvPushMatrix();
  mat4.translate(mvMatrix, [0.0, 0.0, 0.0]);
  NIK = NIK + 1;
...
function MOON(TXL, TYL, TZL) {
  ...
  gl.drawElements(
    gl.TRIANGLES,
    moonVertexIndexBuffer.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
...
function SKY(TXL, TYL, TZL, tekstura) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferSKY.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferSKY.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferSKY.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
  mvPopMatrix();
...
function BANERPOZ(TXL, TYL, TZL, tekstura) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferBOCNI1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    cubeVertexNormalBufferBOCNI1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferBOCNI1.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferBOCNI1.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
...
function NEBODESNO(TXL, TYL, TZL, tekstura) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferNEBODESNO.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferNEBODESNO.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferNEBODESNO.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
  mvPopMatrix();
...
function banertabla(TX, TY, TZ, tekstura) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferBT.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    cubeVertexNormalBufferBT.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferBT.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferBT.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
...
function SKY(TX, TY, TZ, tekstura) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    cubeVertexNormalBufferSKY.itemSize,
    gl.FLOAT,
    false,
    0,
    0
...
function HOLDERY(TXL, TYL, TZL, tekstura) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferREKLAMA.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferREKLAMA.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferREKLAMA.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
  mvPopMatrix();
...
function CUBE(TXL, TYL, TZL, tekstura) {
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexPositionAttribute,
    cubeVertexPositionBufferKLASIK.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.vertexNormalAttribute,
    cubeVertexNormalBufferKLASIK.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.vertexAttribPointer(
    shaderProgram.textureCoordAttribute,
    cubeVertexTextureCoordBufferKLASIK.itemSize,
    gl.FLOAT,
    false,
    0,
    0
  ...
  gl.drawElements(
    gl.TRIANGLES,
    cubeVertexIndexBufferKLASIK.numItems,
    gl.UNSIGNED_SHORT,
    0
  );
  mvPopMatrix();
